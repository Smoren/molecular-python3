...
class Simulation:
    ...
    def _draw_link(self, lhs_idx, rhs_idx):
        lhs_color = ATOMS_COLORS[int(self._atoms[lhs_idx, COL_TYPE])]
        rhs_color = ATOMS_COLORS[int(self._atoms[rhs_idx, COL_TYPE])]
        self._drawer.draw_line(
            self._atoms[lhs_idx, [COL_X, COL_Y]],
            self._atoms[rhs_idx, [COL_X, COL_Y]],
